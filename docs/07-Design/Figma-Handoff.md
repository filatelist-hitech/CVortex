...
5. In `01 Foundations`, place the contrast, focus, keyboard, reduced-motion, responsive and content rules from [[Design-Foundation]]. Do not represent `PENDING` and `CONFIRMED` with color alone.
